    ...
    <div className="col-lg-12 col-md-12"> 
      <div className="mt-4 mb-5"> 
        ...
        <div className="tab-content" id="myTabContent"> 
          ...
          <TabsItem tabId={ 'not-finished' } title={ 
titleTodoNotFinished } isActive={ true } todos={ todosNotFinished } 
onDelete={ onDelete } onTodoFinished={ onTodoFinished }></TabsItem> 
 
          <TabsItem tabId={ 'finished' } title={ titleTodoFinished } 
isActive={ false } todos={ todosFinished } onDelete={ onDelete } 
onTodoFinished={ onTodoFinished }></TabsItem> 
