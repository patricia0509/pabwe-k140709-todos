          ...
          <div className="border p-3"> 
            ...
            <form id="form" onSubmit={ this.onSubmitEventHandler }> 
              ...
              <div className="form-group mb-3"> 
                <label htmlFor="inputTitle" className="form
label">Title</label> 
                <div className="input-group"> 
                  <input onInput={ this.onTitleChangeEventHandler } 
type="text" className="form-control" id="inputTitle" 
value={this.state.title} /> 
                  <span className="input-group-text">{ 50 - 
this.state.title.length }</span> 
                </div> 
              </div> 
              <div className="form-group mb-3"> 
                <label htmlFor="inputDescription" className="form
label">Description</label> 
                <textarea onInput={ 
this.onDescriptionChangeEventHandler } className="form-control" 
id="inputDescription" rows="5" value={this.state.body}></textarea> 
              </div> 
